# Generated by Django 5.2.5 on 2025-08-15 07:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'Available'), ('sold', 'Sold'), ('removed', 'Removed')], default='available', max_length=10)),
        ...
        migrations.AddField(
            model_name='listing',
            name='subcategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listings.subcategory'),
        ),
    ]
